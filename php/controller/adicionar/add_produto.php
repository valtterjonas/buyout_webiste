...
*/
    ...
    echo json_encode( array($p_nome,$p_numero,$p_quantidade,$p_estado,$p_genero,$p_tamanho,$p_categoria,$usuario_codigo,$data_criacao,$data_criacao,$data_criacao,$end_data_criacao));
